...
if __name__ == "__main__":
    ...
    video_path = r"runs\detect\yolov8x_final\frame2video_pre.avi"
    ...
    ## count each label
    annotationDir = r"E:\research_proj\dip_final_proj\ultralytics\runs\detect\yolov8x_final\labels"
    imgDir = r"E:\research_proj\dip_final_proj\ultralytics\runs\video2images"

    annotationFiles = os.listdir(annotationDir)
    # Sort the image files based on their numerical names
    annotationFiles.sort(key=lambda x: int(''.join(filter(str.isdigit, x))))
    ...
    output_video_path = r"runs\imgs2video\person_dog_yolov8x_final.mp4"
